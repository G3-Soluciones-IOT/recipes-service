package pe.edu.upc.recipes_service.shared.infrastructure.persistence.jpa.configuration;
...
public class FlywayMigrationConfiguration {
    ...
    private static final String FLYWAY_MIGRATOR_BEAN_NAME = "recipesFlywayMigrator";
    ...
    public InitializingBean recipesFlywayMigrator(Flyway flyway) {
        return () -> {
    ...
    @Bean
    public static BeanFactoryPostProcessor recipesEntityManagerFactoryDependsOnFlyway() {
        return beanFactory -> {
