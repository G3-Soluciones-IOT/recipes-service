package pe.edu.upc.recipes_service.shared.infrastructure.authorization;
...
final class RecipesJwtAuthenticationConverter {

    private RecipesJwtAuthenticationConverter() {
    }

    static JwtAuthenticationConverter jwtAuthenticationConverter() {
        var authenticationConverter = new JwtAuthenticationConverter();
        authenticationConverter.setJwtGrantedAuthoritiesConverter(new RecipesGrantedAuthoritiesConverter());
        return authenticationConverter;
    }

    private static final class RecipesGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
        @Override
